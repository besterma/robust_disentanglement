...
def visualize_dataset(
    dataset_name, output_path, num_animations=5, num_frames=20, fps=10
):
    ...
    for i in range(num_animations):
        ...
        for j, num_atoms in enumerate(data.factors_num_values):
            ...
            factors[:, j] = visualize_util.cycle_factor(
                base_factor[0, j], num_atoms, num_frames
            )
            images.append(data.sample_observations_from_factors(factors, random_state))
