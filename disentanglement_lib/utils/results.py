...
def update_result_directory(
    result_directory, step_name, results_dict, old_result_directory=None
):
    ...
    gin_config_path = os.path.join(result_directory, "gin", "{}.gin".format(step_name))
