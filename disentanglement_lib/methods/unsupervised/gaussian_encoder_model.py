...
def export_as_tf_hub(
    gaussian_encoder_model,
    observation_shape,
    checkpoint_path,
    export_path,
    ...
    def module_fn(is_training):
        ...
        with tf.variable_scope(tf.get_variable_scope(), reuse=tf.AUTO_REUSE):
            ...
            hub.add_signature(
                ...
                outputs={"mean": mean, "logvar": logvar},
            )
            ...
            decoded_images = gaussian_encoder_model.decode(
                latent_placeholder, observation_shape, is_training
            )
    ...
    spec = hub.create_module_spec(
        module_fn, tags_and_args=tags_and_args, drop_collections=drop_collections
    )
